...
def seed():
    ...
    with app.app_context():
        ...
        products_data = [
            ...
            ('AU-SWH', 'Auriculares Sony WH-1000', 650000, 950000, 22, 5, 30, 'Audio', 'TechDistrib PY'),
            ('CAB-HD2', 'Cable HDMI 2m', 18000, 35000, 80, 20, 200, 'Accesorios', 'Oficentro SRL'),
        ]
        ...
        clients_data = [
            ...
            ('Tech Solutions PY', 'info@techsol.com.py', '021-777888', '80099887-1'),
        ]
        ...
        # Settings
        default_settings = [
            ('auto_order_threshold', '20', 'Stock % para generar pedido automático'),
        ...
        print("   Admin: admin@autostore.com / admin123")
